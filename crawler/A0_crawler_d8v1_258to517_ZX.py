...
def main(keyWords,startPage=0,totalPage=517):
    ...
    #     mainPage.encoding="gzip"
        # print(mainPage.json)
        d8v1Json=json.loads(mainPage.text)

        if "mainPageJSON" not in os.listdir("."):
            os.mkdir("mainPageJSON")

        with open("mainPageJSON/d8v1_{}.json".format(i),"w+",encoding="utf8") as d8v1JsonFile:
...
if __name__=="__main__":
    main("trade war electronic",258,517)